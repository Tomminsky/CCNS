...
class ScholarQuerier(object):
    ...
    def send_query(self, query):
        ...
        self.clear_articles()
        self.query = query
        tmpurl='https://scholar.google.com/scholar?start='+str(query.num_results*10)+'&q='+query.words_some+'&hl=en&as_sdt=0,5'#&num='+str(int(round(np.random.random()*18)+1))
        html = self._get_http_response(url=tmpurl,
